                    ...
                    <form method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="" name="parent_id" class="form-control">
                                    ...
                                    <?php foreach ($parentData as $parent_key => $parent_value) { ?>
                                        <option value="{{ $parent_value->id }}">{{ $parent_value->name }}</option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="value" name="value" placeholder="Enter value" value="{{ request()->old('value') }}">
