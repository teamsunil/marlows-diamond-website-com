                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <input type="text" id="page" name="page" class="form-control" value="{{ $record->page }}"
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <textarea rows="6" id="header_script" placeholder="Header script" name="header_script" class="form-control">{{ $record->header_script }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <textarea rows="6"  id="footer_script" placeholder="Footer script" name="footer_script" class="form-control">{{ $record->footer_script }}</textarea>
